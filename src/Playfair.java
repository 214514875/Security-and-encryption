    ...
    String PlayFair(String key, String text, boolean flag) {
        ...
        if (flag) {
            ...
            for(int i=0;i<text.length()/2;i++){
              row1 = (int)getRowCol(text.charAt(cnt), table).charAt(0);
              col1 = (int)getRowCol(text.charAt(cnt), table).charAt(1);
              row2 = (int)getRowCol(text.charAt(cnt+1), table).charAt(0);
              col2 = (int)getRowCol(text.charAt(cnt+1), table).charAt(1);
